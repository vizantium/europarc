    ...
    return (
        <Grid className={styles.contactsMain}>
            <Grid container className={styles.contactBlock}>
                <Grid sx={{height: '100%'}} md={6} item>
                    <Typography sx={{fontSize: '46px', fontWeight: 600, lineHeight: '24px', letterSpacing: '0.01em'}}>Scrie-ne</Typography>
                    ...
                    <form onSubmit={handleSubmit}>
                        <TextField required sx={{marginTop: '100px'}} id="standard-basic" label="Nume Prenume" variant="standard" fullWidth />
                    ...
                    <Grid sx={{display: 'flex', alignItems: 'center', marginTop: '90px'}}>
