...
const GetSign = () => {
    return (
        <Grid className={styles.getSignMain}>
            <Grid sx={{maxWidth: '580px', marginTop: '110px', paddingBottom: '140px'}}>
                <Typography sx={{color: '#161D39', fontSize: '48px', lineHeight: '72px', fontWeight: 500}}>Comandă semnătura</Typography>
                ...
                <Grid sx={{display: 'flex', marginTop: '5px'}}>
                    <Typography sx={{fontWeight: 700, fontSize: '20px', letterSpacing: '0.06em', lineHeight: '30px'}}>Preț:</Typography>
                    <Typography sx={{fontWeight: 700, fontSize: '20px', letterSpacing: '0.06em', lineHeight: '30px', marginLeft: '5px'}}>100 MDL</Typography>
                </Grid>
                <div className={styles.line} style={{marginTop: '15px'}}/>
                <FormGroup sx={{marginTop: '55px', display: 'flex', justifyContent: 'left', alignItems: 'normal' }}>
